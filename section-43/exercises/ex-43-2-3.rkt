...
;; how-many-descendants : ftn -> number
;; Counts the number of descendants a given node has.
(define (how-many-descendants ft)
  (local ((define (how-many-descendants/list l)
           (cond
            [(empty? l) 1]
            [else (+ (how-many-descendants (first l))
                     (how-many-descendants/list (rest l)))])))
  (cond
   [(empty? (person-children ft)) 1]
   [else (how-many-descendants/list (person-children ft))])))
...
(= (how-many-descendants gustav) 1)
(= (how-many-descendants carl) 5)
(= (how-many-descendants bettina) 5)
(= (how-many-descendants adam) 1)
(= (how-many-descendants eva) 2)
