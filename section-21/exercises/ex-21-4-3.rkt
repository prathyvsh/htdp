...
(define green-circle (make-circle (make-posn 100 50) 10 'green))

(draw-shape red-circle)
(clear-shape red-circle)

(draw-shape green-circle)
(draw-shape (translate-shape green-circle 10))

(draw-shape pink-r)
(clear-shape pink-r)

(draw-shape pink-r)
(draw-shape (translate-shape pink-r 21))
